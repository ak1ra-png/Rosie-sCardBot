module.exports = {
    ...
    IDENTITYSECRET: "",
    STEAMAPIKEY: "",
    ID: "103582791429670253", // Invite users to this group, group ID not URL. Go here to get your group ID: https://steamcommunity.com/groups/<GroupName>/memberslistxml/?xml=1
    PLAYGAMES: [":sets: Sets | Buying 21 Sets 1 Key | Selling 18 Sets 1 Key"], // NonSteam gamed being displayed on profile. 730 is number of game it will idle hours of [730 = csgo]
    ...
    ADMINS: ["76561198880456967"], // Repeat pattern for more admins
    OWNER: "https://steamcommunity.com/id/ak1rawr/",
    INVITE: "",
    ...
    MESSAGES: {
        WELCOME: "Hello there. I'm Rose's Level Service!. Use !check, !buy or !help. Report any issues to http://steamcommunity.com/id/ak1rawr",
